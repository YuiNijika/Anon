...
class Statistics
{
    ...
    public static function getPostsCount(): int
    {
        return self::safeQuery(function () {
            return QueryBuilder::table('posts')->count();
        });
    }
    ...
    {
        return self::safeQuery(function () {
            return QueryBuilder::table('comments')->count();
        });
    }
    ...
    {
        return self::safeQuery(function () {
            return QueryBuilder::table('attachments')->count();
        });
    }
    ...
    {
        return self::safeQuery(function () {
            return QueryBuilder::table('attachments')
                ->sum('file_size');
        });
    }
    ...
    {
        return self::safeQuery(function () {
            return QueryBuilder::table('metas')
                ->where('type', 'category')
                ->count();
        });
    }

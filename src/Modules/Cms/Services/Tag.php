...
class Tag
{
    ...
    {
        $params = Hook::apply_filters('cms_tag_list_params', [
            'search' => $search,
        ]);
        ...
        return Hook::apply_filters('cms_tag_list_result', $result, [
            'search' => $search,
        ]);
    }
    ...
    public static function createTag(array $data): ?array
    {
        ...
        $insertData = Hook::apply_filters('cms_tag_before_insert', [
            'name' => $name,
            'slug' => $slug,
            'type' => 'tag',
        ], ['action' => 'create']);
        ...
        Hook::do_action('cms_tag_after_create', $tagId, $insertData);
    ...
    public static function updateTag(int $id, array $data): ?array
    {
        ...
        $updateData = Hook::apply_filters('cms_tag_before_update', [
            'name' => $name,
            'slug' => $slug,
        ], ['id' => $id, 'action' => 'update']);
        ...
        Hook::do_action('cms_tag_after_update', $id, $updateData);
    ...
    public static function deleteTag(int $id): bool
    {
        ...
        Hook::do_action('cms_tag_before_delete', $id, $tag);
        ...
        if ($result !== false) {
            Hook::do_action('cms_tag_after_delete', $id, $tag);
        }

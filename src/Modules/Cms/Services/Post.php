...
class Post
{
    ...
    {
        $params = Hook::apply_filters('cms_post_list_params', [
            'page' => $page,
            'page_size' => $pageSize,
            'type' => $type,
            'status' => $status,
        ...
        if ($checkPermission && !Admin::isAdmin()) {
        ...
        return Hook::apply_filters('cms_post_list_result', $result, [
            'page' => $page,
            'page_size' => $pageSize,
            'type' => $type,
            'status' => $status,
    ...
    public static function createPost(array $data, int $userId): ?array
    {
        ...
        $type = isset($data['type']) && $data['type'] !== '' ? (string) $data['type'] : 'post';
        ...
        $insertData = Hook::apply_filters('cms_post_before_insert', [
            'title' => $title,
            'slug' => $slug,
            'content' => $content,
        ...
        Hook::do_action('cms_post_after_create', $postId, $insertData);
    ...
    public static function updatePost(int $id, array $data): ?array
    {
        ...
        $updateData = Hook::apply_filters('cms_post_before_update', [
            'title' => $title,
            'slug' => $slug,
            'content' => $content,
        ...
        Hook::do_action('cms_post_after_update', $id, $updateData);
    ...
    public static function deletePost(int $id): bool
    {
        ...
        Hook::do_action('cms_post_before_delete', $id, $post);
        ...
        if ($result !== false) {
            Hook::do_action('cms_post_after_delete', $id, $post);
        }

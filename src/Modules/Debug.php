...
class Debug
{
    ...
    {
        Common::Header(403);
        ResponseHelper::forbidden('需要管理员权限才能访问 Debug 控制台');
        exit;
    }
    ...
    public static function debugInfo(): void
    {
        ...
        ResponseHelper::success($debugData, 'Debug info retrieved successfully');
    }
    ...
    public static function performanceApi(): void
    {
        ...
        Common::Header();
        ResponseHelper::success(self::$performance, 'Performance data retrieved successfully');
    }
    ...
    public static function logs(): void
    {
        ...
        Common::Header();
        ResponseHelper::success(self::$collectors['logs'] ?? [], 'Logs retrieved successfully');
    }
    ...
    public static function errors(): void
    {
        ...
        Common::Header();
        ResponseHelper::success(self::$errors, 'Errors retrieved successfully');
    }
    ...
    public static function tools(): void
    {
        ...
        ResponseHelper::success($tools, 'Debug tools retrieved successfully');
    }
    ...
    public static function clearData(): void
    {
        ...
        Common::Header();
        self::clear();
        ResponseHelper::success(null, 'Debug data cleared successfully');
    }
    ...
    public static function login(): void
    {
        if (!self::checkDebugEnabled()) {
            Common::Header(403);
            ResponseHelper::forbidden('Debug 模式未启用');
        }
        self::setCacheHeaders();
        header('Content-Type: text/html; charset=utf-8');

        try {
            Common::Components('Debug/Login');
        } catch (RuntimeException $e) {
            Common::Header(500);
            ResponseHelper::error('登录页面文件不存在', null, 500);
        }
        exit;
    }
    ...
    public static function console(): void
    {
        ...
        try {
            Common::Components('Debug/Console');
        } catch (RuntimeException $e) {
            Common::Header(500);
            ResponseHelper::error('控制台页面文件不存在', null, 500);
        }
        exit;
    }
    ...
    {
        $cacheEnabled = Env::get('app.debug.cache.enabled', false);
        $cacheTime = Env::get('app.debug.cache.time', 0);

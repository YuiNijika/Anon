...
class QueryBuilder
{
    ...
    /**
     * @param Connection|mysqli $connection 数据库连接
    ...
    public function get(): array
    {
        ...
        if ($stmt instanceof mysqli_stmt) {
            ...
            Debug::query($sql, $this->bindings, $duration);
            ...
            if ($this->cacheEnabled) {
                $cacheKey = $this->getCacheKey();
                Cache::set($cacheKey, $rows, $this->cacheTtl);
            }

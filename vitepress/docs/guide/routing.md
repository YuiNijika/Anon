...
```php
$hasConfig = file_exists(ANON_ROOT . 'app/useRouter.php');
$mode = $hasConfig ? 'manual' : 'auto-scan';

Anon_Debug::info("Router mode: {$mode}");
```
...
- [中间件系统](extension-system.md) - 中间件开发

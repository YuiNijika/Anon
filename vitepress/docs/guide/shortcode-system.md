...
**示例：**
```
[Anon_Plugin_Editor placeholder="输入内容..." height="300px"]
```

### `[Anon_Plugin_Gallery]` - 图片画廊
...
**示例：**
```
[Anon_Plugin_Gallery images="url1,url2,url3" columns="2" gap="12"]
```

### `[Anon_Plugin_Alert]` - 警告框
...
**示例：**
```
[Anon_Plugin_Alert type="success" title="操作成功" closable="true"]
```
...
#### `Anon_System_Shortcode::render_react_component(string $component_name, array $props = []): string`

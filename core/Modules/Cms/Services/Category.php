 ...
 * CMS 分类服务层
 */
class Anon_Cms_Services_Category
{
    /**
     * 获取单个分类
     * @param int $id 分类ID
    ...
    {
        $params = Anon_System_Hook::apply_filters('cms_category_list_params', [
            'search' => $search,
        ]);
        ...
        return Anon_System_Hook::apply_filters('cms_category_list_result', $result, [
            'search' => $search,
        ]);
    }
    ...
    public static function createCategory(array $data): ?array
    {
        ...
        $insertData = Anon_System_Hook::apply_filters('cms_category_before_insert', [
            'name' => $name,
            'slug' => $slug,
            'type' => 'category',
        ...
        Anon_System_Hook::do_action('cms_category_after_create', $categoryId, $insertData);
    ...
    public static function updateCategory(int $id, array $data): ?array
    {
        ...
        $updateData = Anon_System_Hook::apply_filters('cms_category_before_update', [
            'name' => $name,
            'slug' => $slug,
            'description' => $description,
            'parent_id' => $parentId,
        ...
        Anon_System_Hook::do_action('cms_category_after_update', $id, $updateData);
    ...
    public static function deleteCategory(int $id): bool
    {
        ...
        Anon_System_Hook::do_action('cms_category_before_delete', $id, $category);
        ...
        if ($result !== false) {
            Anon_System_Hook::do_action('cms_category_after_delete', $id, $category);
        }
